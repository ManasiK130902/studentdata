...
export default function EditStudent(){
    ...
    const handleSubmit = (e) => {
        ...
        if(id.toString().trim() === "" || !isNumeric(id.toString())) {
            setValidation(true);
            return;
        }
    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                />
                {id.toString().length === 0 && validation && <span className="errorMsg">Please enter an ID</span>}
                {id.toString().length > 0 && !isNumeric(id.toString()) && validation && <span className="errorMsg">ID must be a number</span>}
